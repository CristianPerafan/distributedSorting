...
public interface CallbackSenderPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void sendMessage(CallbackReceiverPrx proxy, String msg, java.util.Map<String, String> context)
    {
        _iceI_sendMessageAsync(proxy, msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sendMessageAsync(CallbackReceiverPrx proxy, String msg)
    {
        return _iceI_sendMessageAsync(proxy, msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sendMessageAsync(CallbackReceiverPrx proxy, String msg, java.util.Map<String, String> context)
    {
        return _iceI_sendMessageAsync(proxy, msg, context, false);
    }
