...
{
    default String sendMsgAsync(String msg)
        throws RequestCanceledException
    {
        return sendMsgAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String sendMsgAsync(String msg, java.util.Map<String, String> context)
        throws RequestCanceledException
    {
        try
        {
            return _iceI_sendMsgAsyncAsync(msg, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> sendMsgAsyncAsync(String msg)
    {
        return _iceI_sendMsgAsyncAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> sendMsgAsyncAsync(String msg, java.util.Map<String, String> context)
    {
        return _iceI_sendMsgAsyncAsync(msg, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_sendMsgAsyncAsync(String iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sendMsgAsync", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_sendMsgAsync);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_sendMsgAsync =
    {
